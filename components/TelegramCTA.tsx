...
export function TelegramCTA() {
  return (
    <section className="w-full max-w-4xl mx-auto mt-16 px-4">
      <div className="relative bg-white rounded-3xl border-b-8 border-r-4 border-orange-500 shadow-xl overflow-hidden p-8 md:p-10 transform transition-all hover:-translate-y-1 hover:shadow-2xl duration-300">
        <div className="absolute top-0 right-0 -mt-10 -mr-10 w-48 h-48 bg-yellow-300 rounded-full blur-3xl opacity-50" />
        <div className="absolute bottom-0 left-0 -mb-10 -ml-10 w-48 h-48 bg-orange-200 rounded-full blur-3xl opacity-50" />
        <div className="relative flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left z-10">
            <h3 className="text-2xl md:text-3xl font-extrabold mb-2 text-gray-900 italic tracking-tight">
          ...
          <div className="flex-shrink-0">
            <a href={SITE.telegram} target="_blank" rel="noopener noreferrer"
               className="group relative inline-flex items-center gap-3 bg-[#229ED9] hover:bg-[#1c8bb4] text-white font-bold py-4 px-8 rounded-xl shadow-lg transition-all duration-300 hover:shadow-blue-300/50 hover:-translate-y-1">
            ...
            <div className="mt-2 flex justify-center md:justify-start items-center gap-1 text-xs font-bold text-gray-400 uppercase tracking-widest">
